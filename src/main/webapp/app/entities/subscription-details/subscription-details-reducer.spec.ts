...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscription-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSCRIPTIONDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSCRIPTIONDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSCRIPTIONDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSCRIPTIONDETAILS actions', async () => {
      const arg = 42666;
