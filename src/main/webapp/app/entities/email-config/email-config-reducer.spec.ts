...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMAILCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMAILCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EMAILCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EMAILCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMAILCONFIG actions', async () => {
      const arg = 42666;
